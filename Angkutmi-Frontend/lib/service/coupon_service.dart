...
class CouponService {
  ...
  // static const String baseUrl = 'http://192.168.251.1:8080'; // Base URL variable
  ...
  Future<List<Map<String, dynamic>>> fetchCoupons() async {
    try {
      ...
      final response = await http.get(
        Uri.parse('$baseUrl/api/coupons/'), // Using baseUrl
        headers: {
  ...
  Future<List<Map<String, dynamic>>> fetchClaimedCoupons() async {
    try {
      ...
      final response = await http.get(
        Uri.parse('$baseUrl/api/coupons/inventory'), // Using baseUrl
        headers: {
          'Authorization': 'Bearer $token',
        },
      );
  ...
  Future<void> redeemCoupon(String couponCode) async {
    try {
      ...
      final response = await http.post(
        Uri.parse('$baseUrl/api/coupons/$couponCode/redeem'), // Using baseUrl and couponCode
        headers: {
  ...
  Future<List<Map<String, dynamic>>> fetchRedeemedProducts() async {
    try {
      ...
      final response = await http.get(
        Uri.parse('$baseUrl/api/coupons/redeemed'), // Using baseUrl
        headers: {
          'Authorization': 'Bearer $token',
        },
      );
