...
// API endpoint URLs
const String apiLoginUrl = 'http://192.168.251.1:8080/api/login';
const String apiLogoutUrl = 'http://192.168.251.1:8080/api/logout';
...
class AuthService {
  ...
  Future<Map<String, dynamic>> register(
    ...
    final url = Uri.parse('http://192.168.251.1:8080/api/register');
...
Future<void> logout(BuildContext parentContext) async {
  try {
    ...
    final response = await http.post(
      Uri.parse('http://192.168.251.1:8080/api/logout'),
      headers: {
