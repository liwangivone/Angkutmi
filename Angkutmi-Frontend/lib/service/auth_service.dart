...
// API endpoint URLs
const String apiLoginUrl = 'http://192.168.163.176:8000/api/login';
const String apiLogoutUrl = 'http://192.168.163.176:8000/api/logout';
...
class AuthService {
  ...
  Future<Map<String, dynamic>> register(
    ...
    final url = Uri.parse('http://192.168.163.176:8000/api/register');
...
Future<void> logout(BuildContext parentContext) async {
  try {
    ...
    final response = await http.post(
      Uri.parse('http://192.168.163.176:8000/api/logout'),
      headers: {
